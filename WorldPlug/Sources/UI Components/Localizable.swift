...
enum LocalizationKeys {
    ...
    static let tripCheckScanSuccessTitle = LocalizedStringResource("trip.check.scan.success.title")
    static let tripCheckScanSuccessMessage = LocalizedStringResource("trip.check.scan.success.message")
    static let tripCheckScanSuccessReview = LocalizedStringResource("trip.check.scan.success.review")
    ...
    static let tripEditorNameIdeas = LocalizedStringResource("trip.editor.name.ideas")
    static let tripEditorNameIdeaDiscover = LocalizedStringResource("trip.editor.name.idea.discover")
    static let tripEditorNameIdeaEscape = LocalizedStringResource("trip.editor.name.idea.escape")
    static let tripEditorNameIdeaMyTrip = LocalizedStringResource("trip.editor.name.idea.my.trip")
