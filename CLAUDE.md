...
Features/
  ...
  SavedCountries/        Tab 3 — saved countries (premium-gated)
...
**Still to come**: Chunk C — strip the Saved tab to a plain favorites list, add a full-screen Settings screen behind a gear in the Countries toolbar (home country, favorite-widget country, premium/restore, about, debug), and move the saved-country soft lock (free = 3) to the save action in Countries/CountryDetail.
