...
| Apple Watch Series 12 (46mm) | 416 × 496 (portrait) | **Yes**, since the Watch app ships with the iOS app | Captured and framed by `bundle exec fastlane watch_screenshots` |
...
To generate the Watch set, run this in addition:
```bash
